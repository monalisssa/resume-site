...
const ContactMeForm = () => {
            ...
            <div className="d-flex justify-content-center gap-5 align-items-start form-container mt-5">
                <Form className="d-flex flex-column" onSubmit={sendEmail} style={{width: "40%"}}>
                    ...
                    <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                        ...
                        <Form.Control type="email" name="email_form" className="fs-5" required  onChange={(e) => setEmail(e.target.value)} value={email}/>

                        <Form.Label className="mt-3">Message:</Form.Label>
                        <Form.Control as="textarea" rows={5} name="message" className="fs-5" required  onChange={(e) => setMessage(e.target.value)} value={message}/>
                    </Form.Group>
    ...
    {
        show &&
        <div className="position-fixed top-0 w-100 d-flex align-items-center justify-content-center alert">
            <Alert
                className="w-100"
                severity="success"
                action={
